...
<tr bgcolor="orange"> <td align="center" colspan="7"> <font size="5">
<b>Add Book Information</b>
</font>
</td></tr>
<tr bgcolor="lightyellow"> <td align="center" colspan="3"><font size="4" color="red"><b><jlc:error property="addingBookError"/>
</b></font></td></tr>
<core:if test="${SHOW_ADD_BOOK ne 'OK'}">
<tr><td align="center" > <font size="5" > <b> Book Name</b></font></td>
<td><input type="text" size="35" style="color:black; background-color:#b4e0d2; font-size:20" name="bname">
</td><td>
<font size="4" color="red"><b><jlc:error property="bname"/>
</b></font></td></tr>
...
<td><input type="text" size="35" style="color:black; background-color:#b4e0d2; font-size:20" name="author">
</td>
<td>
...
<td><input type="text" size="35" style="color:black; background-color:#b4e0d2; font-size:20" name="cost">
</td>
<td>
...
<td><input type="text" size="35" style="color:black; background-color:#b4e0d2; font-size:20" name="publication">
</td>
<td>
...
</core:if></table></center></form></body></html>
