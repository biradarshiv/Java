...
<font size="5" ><b>Personal Details</b></font></td></tr>


<core:if test="${updateError ne null">
<tr bgcolor="lightyellow">
<td align="center" colspan="3">
<font color="red" size="4"><b>${updateError }</b></font></td>
</tr>
</core:if>
...
<td colspan="2">
<font size="3"><b>${USER_TO.firstName }</b></font></td>
</tr>

<tr bgcolor="#dee1fe">
<td>
<font size="3"><b>Email</b></font></td>
<td>
...
<tr bgcolor="#e1ffde"><td><font size="3"><b>Phone</b></font></td>
<td>
<core:if test="${EDIT_INFO eq null"}>
...
<tr bgcolor="#fdeaff"><td><font size="3"><b>Username</b></font></td>
<td colspan="2"><font size="3"><b>${USER_TO.username}</b></font></td></tr>

<tr bgcolor="#dee1fe"><td><font size="3"><b>Password</b></font></td>
<td colspan="2"></td></tr>

<tr bgcolor="maroon">
<core:if test="${EDIT_INFO eq null}">
<td align="center" colspan="3">
<a  href="editinfo.jlc"><font size="4"><b>Edit</b></font></a></td>
</core:if>


<core:if test="${EDIT_INFO ne null}">
<td align="center">
<a  href="canceledit.jlc"><font size="4"><b>Cancel</b></font></a></td>
<td align="center">
